      ...
      body: Center(
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  onSaved: (value){if(value != null)picture= value;},
                ),
                TextFormField(
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(hintText: "price"),
                  onSaved: (value){if(value != null)price= double.parse(value) ;},
                ),
                TextFormField(
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(hintText: "rating"),
                  onSaved: (value){if(value != null)rating= double.parse(value);},
                ),
                TextFormField(
                  decoration: InputDecoration(hintText: "seller"),
                  onSaved: (value){if(value != null)seller= value;},
                ),
                TextFormField(
                  decoration: InputDecoration(hintText: "tag"),
                  onSaved: (value){if(value != null)tag= value;},
                )
              ],
            ),
          ),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async {
            ...
            db.addProduct(category, name, picture, price, rating, "", tag); //seller null yerine eklenecek !!!!
          },
        )
      );
  }
