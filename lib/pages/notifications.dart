                     ...
                     if(listofnotify!= null){
                       return Padding(
                         ...
                         child: Card(
                           ...
                           child: ListTile(
                             onTap: (){},
                             title:Text('${listofnotify[index]["notify"]}',style: TextStyle(color: AppColors.notification,
                                 fontWeight: FontWeight.bold ),
                             ),
                             trailing: IconButton(onPressed: ()async{
                               //if(notify.get())
                               print(listofnotify[index]["notify"]);
                               await listofnotify[index].reference.delete();
                               //listofnotify[index]["notify"].delete();
                             },icon: Icon(Icons.delete), color:AppColors.notification ,iconSize:30 ,),
                             leading: IconButton(onPressed: (){},icon: Icon(Icons.arrow_right_alt_rounded), color:Colors.blue ,iconSize:25 ,),
                           ),
                         ),
                       );}
                     else{
              ...
              // mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 Column(
                   ...
                   children: [
                     Text("Product Announcements",style: kSmallTitle,),
